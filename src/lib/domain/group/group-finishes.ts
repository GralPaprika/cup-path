...
import { normalizeGroupFinish } from "@/lib/domain/group/group-finish-swap";
...
export type { GroupFinishMap } from "@/lib/domain/group/group-finish-swap";
export { swapGroupPositions } from "@/lib/domain/group/group-finish-swap";
